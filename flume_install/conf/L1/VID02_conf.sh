...
agent1.sources.udp-source1.port = 65112  
...
agent1.sinks.avro-sink1.port =  $vcollect_port1  
...
agent1.sinks.avro-sink1r.port =  $vcollect_port2  
...
agent1.sources.udp-source2.port = 65115  
...
agent1.sinks.avro-sink2.port = $vcollect_port1  
...
agent1.sinks.avro-sink2r.port = $vcollect_port2  
