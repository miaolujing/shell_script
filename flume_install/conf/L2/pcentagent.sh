...
agent1.sources.udp-source${i}1.port = 65011
...
agent1.sinks.avro-sink${i}1.port = $pcollect_port1
...
agent1.sinks.avro-sink${i}1r.port = $pcollect_port2
...
##### NEED TO UPDATE, UDP PORT ####
agent1.sources.udp-source${i}2.port = 65021
...
#### NEED TO UPDATE, collector avro tcp port #### 
agent1.sinks.avro-sink${i}2.port = $pcollect_port1
...
agent1.sinks.avro-sink${i}2r.port = $pcollect_port2
...
##### NEED TO UPDATE, UDP PORT ####
agent1.sources.udp-source${i}3.port = 65031
...
#### NEED TO UPDATE, collector avro tcp port #### 
agent1.sinks.avro-sink${i}3.port = $pcollect_port1
...
agent1.sinks.avro-sink${i}3r.port = $pcollect_port2
